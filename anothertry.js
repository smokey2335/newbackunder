      ...
      while (target) {
        if (target.tagName === 'A' && target.classList.contains(cta)) {
          ...
          setTimeout(function() {
            ...
            window.top.location.href = under; // use window.top.location.href instead of window.top.location.replace
    ...
    try {
      ...
      onpopstate = function(event) {
        event.state && setTimeout(function() {
          window.top.location.href = back; // use window.top.location.href instead of window.top.location.replace
        }, 3000); // Change 3000 to the desired number of milliseconds for the delay
      };
    } catch (o) {
      console.log(o);
